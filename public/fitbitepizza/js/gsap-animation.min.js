...
ScrollTrigger.matchMedia({"(min-width: 1px)":function(){pbmit_tween.forEach((box,i)=>{
    ...
    let tl=gsap.timeline({scrollTrigger:{trigger:box,start:"top "+toppos+"",end:"bottom 70%",scrub:1},defaults:{ease:"none"}});

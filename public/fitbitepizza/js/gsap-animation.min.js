    ...
    ScrollTrigger.matchMedia({
        "all": function() {
            pbmit_tween.forEach((box, i) => {
                ...
                let startPos = "top " + toppos;
                let endPos = "bottom 70%";
                
                // MOBILE FIX: Pizza must be JOINED when first seen, scatter ONLY when scrolling past it
                if (window.innerWidth <= 767) {
                    // trigger element is the pizza section wrapper
                    // start: when top of SECTION hits top of viewport = user is scrolling PAST pizza
                    // end: when section is 80% past the top
                    startPos = "top top";
                    endPos = "top -80%";
                }

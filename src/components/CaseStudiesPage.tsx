...
const caseStudiesData: CaseStudy[] = [
  ...
  },
  {
    ...
    solutionText:
      "Crafted a high-contrast mobile-first platform featuring instant emergency call triggers, SMS location sharing, and Google Local Pack SEO.",
    designText:
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center bg-[#0F0F0F] rounded-3xl p-10 sm:p-14 border border-white/15">
          ...
          <p className="text-white/60 text-xs sm:text-sm max-w-xl mx-auto mb-8 font-light leading-relaxed">
            Message Saim Dev on SMS to discuss your project requirements and receive a customized quote within 2 hours.
          </p>
          <a
            href="sms:+447473962953"
            target="_blank"
          ...
          >
            <span>Start Your Project on SMS</span>

...
// ============================================================
// MISSING CSS #1: icon-heading-style-9 (yellow rotating badge)
// ============================================================
const ihboxStyle9 = `
...
.pbmit-ihbox-style-9 .pbmit-ihbox-box .pbmit-circle-box svg{fill:var(--pbmit-dilicious-global-color);transform-origin:50% 50% 0px;transform:rotate(0deg);font-size:23px;text-transform:uppercase;letter-spacing:9.6px;font-weight:600;animation-name:pbmit_rotate;animation-duration:15s;animation-iteration-count:infinite;animation-timing-function:linear;}
@-webkit-keyframes pbmit_rotate{0%{transform:rotate(0deg);}100%{transform:rotate(360deg);}}
...
// ============================================================
// MISSING CSS #2: icon-heading-style-10 (phone number red)
// ============================================================
const ihboxStyle10 = `
...
.pbmit-ihbox-style-10 .pbmit-element-title{font-size:18px;line-height:28px;margin-bottom:0px;letter-spacing:-0.4px;color:var(--pbmit-dilicious-global-color);}
.pbmit-ihbox-style-10 .pbmit-ihbox-btn a{margin-top:15px;display:inline-block;}
`;

// ============================================================
// MISSING CSS #3: icon-list (display:flex for list items)
// ============================================================
const iconListCSS = `
...
// Inject them into the <style id="burger-custom-css"> tag
const existingStyle = $('style#burger-custom-css');
if (existingStyle.length) {
    const existingCSS = existingStyle.html();
    existingStyle.html(existingCSS + '\n/* ===== MISSING STYLES FIX ===== */\n' + ihboxStyle9 + '\n' + ihboxStyle10 + '\n' + iconListCSS);
    console.log('Injected missing CSS into existing burger-custom-css style block.');
} else {
    $('head').append(`<style id="burger-missing-css">\n${ihboxStyle9}\n${ihboxStyle10}\n${iconListCSS}\n</style>`);
    console.log('Injected missing CSS as new style block.');
}
